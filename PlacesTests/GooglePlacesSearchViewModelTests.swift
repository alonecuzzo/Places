...
//                observer.on(Event.Next([GMSAutocompletePrediction()]))//can't create one of these - that's ok tho
...
//    }
//    
//    //subclass the autocomplete
//    
//    //fave a nsattributedstring creator then compare the strings
//    
...
//            test_attributedString = attributedString
//            super.init()
//        }
//    }
//    
